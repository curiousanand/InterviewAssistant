...
public enum MessageType {
    ...
    public String getDescription() {
        switch (this) {
            case SESSION_START:
                return "Initialize conversation session";
            case SESSION_READY:
                return "Session ready for interaction";
            case SESSION_END:
                return "End conversation session";
            case SESSION_CLOSED:
                return "Session cleanup completed";
            case AUDIO_DATA:
                return "Raw audio data chunk";
            case AUDIO_START:
                return "Audio capture started";
            case AUDIO_STOP:
                return "Audio capture stopped";
            case TRANSCRIPT_PARTIAL:
                return "Interim transcription result";
            case TRANSCRIPT_FINAL:
                return "Final transcription result";
            case TRANSCRIPT_ERROR:
                return "Transcription failed";
            case ASSISTANT_DELTA:
                return "Streaming AI response token";
            case ASSISTANT_DONE:
            ...
            case PROCESSING_START:
                return "AI processing initiated";
            case PROCESSING_COMPLETE:
                return "AI processing finished";
            case DEBUG_INFO:
