...
public class ParallelProcessingCoordinator {
    ...
    public static class ProcessingStatistics {
        ...
        public int getAudioActiveThreads() {
            return audioActiveThreads;
        }
        ...
        public int getTranscriptionActiveThreads() {
            return transcriptionActiveThreads;
        }

        public int getTranscriptionQueueSize() {
            return transcriptionQueueSize;
        }

        public int getAiActiveThreads() {
            return aiActiveThreads;
        }

        public int getAiQueueSize() {
            return aiQueueSize;
        }
