...
public class StreamingAudioProcessor {
    ...
    public static class AudioSessionConfig {
        ...
        // Getters
        public int getSilenceThresholdMs() { return silenceThresholdMs; }
        public double getEnergyThreshold() { return energyThreshold; }
        public boolean isAdaptiveVAD() { return adaptiveVAD; }
    ...
    public static class AudioProcessingResult {
        ...
        public VADResult getVadResult() { return vadResult; }
        public SilenceDetectionResult getSilenceResult() { return silenceResult; }
