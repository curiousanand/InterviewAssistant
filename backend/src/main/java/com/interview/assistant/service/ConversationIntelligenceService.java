...
public class ConversationIntelligenceService {
    ...
    public static class ResponseStrategy {
        ...
        public ResponseUrgency getUrgency() { return urgency; }
        public long getResponseDelay() { return responseDelay; }
        public ConversationAnalysis getAnalysis() { return analysis; }
    ...
    public static class ConversationAnalysis {
        ...
        public ConversationTone getTone() { return tone; }
    ...
    public static class ConversationIntervention {
        ...
        public List<InterventionType> getInterventions() { return new ArrayList<>(interventions); }
        public ConversationAnalysis getAnalysis() { return analysis; }
