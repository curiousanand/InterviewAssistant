...
public class ConversationContext {
    ...
    public Map<String, Integer> getLanguageFrequency() {
        return languageFrequency;
    }

    public void setLanguageFrequency(Map<String, Integer> languageFrequency) {
        this.languageFrequency = languageFrequency;
    }
    ...
    public Instant getLastSummarizedAt() {
        return lastSummarizedAt;
    }

    public void setLastSummarizedAt(Instant lastSummarizedAt) {
