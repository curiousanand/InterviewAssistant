...
const config: Config = {
  // Optimize for production by purging unused CSS
  content: [
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Custom colors for voice interface
        voice: {
          active: '#10b981',
          inactive: '#6b7280',
          error: '#ef4444',
  ...
  plugins: [
    ...
    // Plugin for scroll area styling
